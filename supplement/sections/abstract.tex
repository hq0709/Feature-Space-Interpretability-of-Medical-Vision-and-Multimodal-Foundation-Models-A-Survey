...
licenses \emph{and what it does not}. Counts describe this corpus, \Pctpreprint\% of it preprints, not the literature; \Nrepstudies{} of
the \Ncore{} studies are returned by a logged retrieval. Clinical findings, anatomy, demographic and acquisition
...
structure is the property most repeatedly reported in this corpus, and whether removing it restores
...
The connector output and the text encoder are almost unmeasured in this corpus. Corpus, logs and scripts
are released.
