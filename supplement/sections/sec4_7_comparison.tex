...
(\S\ref{sec:models}). Counts are from the coded corpus, the other cells are qualitative summaries, and the \Nintrinsic{} intrinsic-design records are counted in their analytic family (thirteen decoding, one
