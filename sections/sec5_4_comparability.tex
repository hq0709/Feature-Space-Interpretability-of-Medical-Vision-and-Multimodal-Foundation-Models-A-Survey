...
\Ngreysingle{} lowers F3c as well (supplementary Tables~S7--S9). Of these studies, \Nextyes{} evaluate on a cohort or
...
Table~S13). Provenance locates where a claim may fail for reasons unrelated to the model.
